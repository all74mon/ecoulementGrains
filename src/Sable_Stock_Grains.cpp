...
void Sable::ajout_bloc(int nombre, const double X[3], const double v[3], const double teta[3], const double omega[3], double rayon, double epsi){ //coordonnes du grain en haut a gauche
