...
void Sable::ajout_bloc(int nombre, double epsi, const double X[3], const double v[3], const double teta[3], const double omega[3],
        double rayon,double masse,double J,double kn,double ks,double cn,double cs) {
